...
- **Quick language switcher** — with Spacebar Language Switch on, swipe left/right on the spacebar (or long-press it) to flip between English, বাংলা, Avro and عربي
